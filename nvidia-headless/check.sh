...
# order reflects dependencies
mlx_modules='mlx_compat ib_core ib_cm ib_ipoib iw_cm rdma_cm ib_iser ib_isert ib_srp ib_umad ib_uverbs irdma knem mlxfw mlxdevm mlx5_core mlx5-vfio-pci mlx5_ib mlx5_vdpa mst_pci mst_pciconf rdma_ucm scsi_transport_srp'
